...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('created_at', models.DateField(auto_now_add=True, help_text='Дата создания сущности')),
                ('amount', models.DecimalField(decimal_places=3, help_text='Кол-во денежных средств в рублях', max_digits=11, validators=[django.core.validators.MinValueValidator(0)])),
